...
export default async function AcopladosPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/acoplados/new" className="btn-primary flex items-center gap-2 shrink-0">
          <Plus size={16} />
      ...
      {trailers.length === 0 ? (
        <div className="card text-center py-16">
          ...
          <Link href="/acoplados/new" className="btn-primary inline-flex items-center gap-2 mt-6">
            <Plus size={16} />
            Agregar acoplado
          </Link>
        </div>
